...
import {
  FutureIntroductionContext,
  FutureChallengeContext,
  FuturePerfectionContext,
  FutureFriedrichContext,
  FutureRelianceContext,
} from '@/components';
      ...
      <main ref={main} className=" w-auto ">
        ...
        <div className="main-container overflow-y-auto">
          <div className=" space-x-100 flex min-h-screen flex-row  items-center">
            ...
            {activeIcon === 'Introduction' && <FutureIntroductionContext />}
            {activeIcon === 'Challenge' && <FutureChallengeContext />}
            {activeIcon === 'Perfection' && <FuturePerfectionContext />}
            {activeIcon === 'Friedrich' && <FutureFriedrichContext />}
            {activeIcon === 'Reliance' && <FutureRelianceContext />}
          </div>
        </div>
      </main>
    </div>
